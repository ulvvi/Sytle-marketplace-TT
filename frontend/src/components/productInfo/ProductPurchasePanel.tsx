    ...
    return (
        <>
            <section className="mt-8 col-span-full lg:col-span-1">
                ...
                <VariantContainer variants={[{id: 1, color: 'black', size: 'XS', stock: 10, productId: 2}, {id: 1, color: 'white', size: 'XS', stock: 12, productId: 2}, {id: 1, color: 'blue', size: 'L', stock: 15, productId: 2}, {id: 1, color: 'blue', size: 'XS', stock: 12, productId: 2}, {id: 1, color: 'red', size: 'S', stock: 0, productId: 2}]}/>
