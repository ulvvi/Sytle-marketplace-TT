        ...
        <>  
            <section className="bg-[#F3F4F633] mb-20 mt-20 px-4">
                ...
                <div className="flex flex-col gap-8 items-center justify-center  w-full mb-12 lg:flex-row">
                    <ProductCard title="Vintage Denim Jacket" ratingAvg={4.8} ratingQuantity={124} currentPrice={89} oldPrice={120} productBadge="Best Seller" cardStyle="Home"/>
                    <ProductCard title="Oversized Blazer" ratingAvg={4.9} ratingQuantity={89} currentPrice={145} productBadge="New" cardStyle="Home"/>
                    <ProductCard title="Comfort Slim Jeans" ratingAvg={4.7} ratingQuantity={203} currentPrice={79} oldPrice={99} productBadge="Sale" cardStyle="Home"/>
                    <ProductCard title="Silk Blouse" ratingAvg={4.8} ratingQuantity={156} currentPrice={125} productBadge="Premium" cardStyle="Home"/>
                </div>
