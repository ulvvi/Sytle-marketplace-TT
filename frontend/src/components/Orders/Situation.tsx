export function Situation(situation: "DELIVERED" | "SHIPPED" | "PROCESSING"){
    return(
        <>
        <div className={`flex items-center px-[11px] pt-[3px] pb-[3px] rounded-[10px] ${situation === "DELIVERED" ? "bg-[#DCFCE7]" : situation === "SHIPPED" ? "bg-[#DBEAFE]" : "bg-[#FEF9C3]"} `}>
